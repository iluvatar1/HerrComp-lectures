...
## How to setup the actions keys

For main repo to sync to the other repo
- Go to repository, settings, secrets and variables, actions
- New repository secret, call it `SYNC_LECTURES` `

For publishing the book, use `ACTIONS_FOR_BOOK_ACCESS_TOKEN`
